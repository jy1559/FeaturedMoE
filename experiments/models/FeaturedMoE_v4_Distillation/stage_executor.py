        ...
        *,
        ...
        for stage_name in self.stage_order:
            ...
            cfg = StageRuntimeConfig(
                ...
                teacher_bias_scale=teacher_bias_scale,
                teacher_stat_sharpness=teacher_stat_sharpness,
            )
        ...
        *,
        ...
        if self.execution == "serial":
            ...
            for stage_name in self.stage_order:
                ...
                router_stage_aux.update(aux)
            return out, gate_weights, gate_logits, None, None, router_stage_aux
        ...
        return merged_hidden, gate_weights, gate_logits, merge_w, merge_l, router_stage_aux
