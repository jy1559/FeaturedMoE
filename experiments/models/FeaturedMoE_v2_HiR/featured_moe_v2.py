...
class FeaturedMoE_V2_HiR(SequentialRecommender):
    """FeaturedMoE_v2_HiR: factorized hierarchical-routing Stage-MoE recommender."""
    ...
    def __init__(self, config, dataset):
        ...
        logger.info(
            "FeaturedMoE_v2_HiR init: layout_id=%s execution=%s global_pre=%s global_post=%s boundaries=%s total_moe_blocks=%s "
