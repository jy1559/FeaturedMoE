"""Unified stage executor for FeaturedMoE_N2."""
...
from ..FeaturedMoE_v2.layout_schema import LayoutSpec
from ..FeaturedMoE_v2.merge_router import StageMergeRouter
from .stage_modules import StageBranchRunnerN2, StageRuntimeConfigN2


_STAGE_NAMES = ("macro", "mid", "micro")


class StageExecutorN2(nn.Module):
    """Execute FeaturedMoE_N2 stage branches in serial or parallel mode."""
    ...
    def __init__(
        ...
        *,
        ...
        router_feature_proj_dim: int,
        router_feature_proj_layers: int,
        router_feature_scale: float,
        router_hidden_scale: float,
        router_group_feature_scale: float,
    ):
        super().__init__()
        ...
        for stage_name in self.stage_order:
            ...
            self.branches[stage_name] = StageBranchRunnerN2(cfg)
    ...
    def forward(
        ...
        *,
        ...
        merged_hidden, stage_merge_weights, stage_merge_logits = self._merge_parallel(
            base_hidden=base_hidden,
            feat=feat,
            stage_deltas=stage_deltas,
        )
        return merged_hidden, gate_weights, gate_logits, router_aux, stage_merge_weights, stage_merge_logits
