...
Usage: $0 [--datasets KuaiRecLargeStrictPosV2_0.2,lastfm0.03] [--gpus 0,1,2,3]
          ...
          [--seed-base 9900] [--manifest-out path] [--dry-run]
          [--only PA01,PD01] [--family A,D]
...
Notes:
- phase2 runner has 40 combos (A16/B4/C8/D12).
- --max-evals 0 means use each combo's launcher default budget.
- --use-recommended-budget only matters when --max-evals > 0.
USAGE
}
