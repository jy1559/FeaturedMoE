...
usage() {
  cat <<USAGE
Usage: $0 --dataset <ds> --parent_result <json> [--mode alpha|temp|topk|combined]
USAGE
}
...
LOG_FILE_PATH="$(run_make_log_path fmoe schedule "$DATASET" "FeaturedMoE_${MODE}" "$GPU_ID" "$PHASE")"
