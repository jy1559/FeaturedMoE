...
"${PY_BIN}" run/fmoe_n4/cross_dataset_a12_portfolio.py \
  --datasets "${N4_DATASETS:-amazon_beauty,foursquare,movielens1m,retail_rocket,lastfm0.03}" \
  --dataset-template-counts "${N4_TEMPLATE_COUNTS:-amazon_beauty:12,foursquare:12,movielens1m:6,retail_rocket:6,lastfm0.03:4}" \
