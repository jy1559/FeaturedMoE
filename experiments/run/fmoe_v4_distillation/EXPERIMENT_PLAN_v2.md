...
## 공통 기록 규칙
- 결과 저장: `experiments/run/artifacts/results/fmoe_v3`
- 로그 저장: `experiments/run/artifacts/logs/fmoe_v3`
...
- `--dry-run`에서 `track=fmoe_v3`와 artifacts 경로 확인

예시(실행 템플릿):
```bash
bash experiments/run/fmoe_v3/train_single.sh --dataset movielens1m --layout-id 0 --execution serial --gpu 0 --dry-run
bash experiments/run/fmoe_v3/train_single.sh --dataset movielens1m --layout-id 2 --execution parallel --gpu 0 --dry-run
```
...
예시:
```bash
bash experiments/run/fmoe_v3/p1_wide_shallow.sh \
...
예시:
```bash
bash experiments/run/fmoe_v3/tune_layout.sh --dataset movielens1m --parent-result experiments/run/artifacts/results/fmoe_v3/<p1>.json --phase P2 --gpu 0 --dry-run
bash experiments/run/fmoe_v3/tune_hparam.sh --dataset movielens1m --layout-id <best_layout> --execution <best_exec> --parent-result experiments/run/artifacts/results/fmoe_v3/<p2>.json --phase P3 --gpu 0 --dry-run
```
...
예시:
```bash
bash experiments/run/fmoe_v3/tune_hparam.sh --dataset retail_rocket --layout-id <best_layout> --execution <best_exec> --max-evals 24 --phase P1 --gpu 1 --dry-run
```
...
예시:
```bash
bash experiments/run/fmoe_v3/tune_schedule.sh --dataset movielens1m --parent-result experiments/run/artifacts/results/fmoe_v3/<p3>.json --mode alpha --phase P4 --gpu 0 --dry-run
bash experiments/run/fmoe_v3/tune_schedule.sh --dataset movielens1m --parent-result experiments/run/artifacts/results/fmoe_v3/<p3>.json --mode combined --phase P4 --gpu 0 --dry-run
```
