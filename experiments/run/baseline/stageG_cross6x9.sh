...
CMD=(
  "${PYTHON_BIN}"
  "${SCRIPT_DIR}/run_stageG_cross6x9.py"
  --datasets "${DATASETS}"
  --models "${MODELS}"
  --gpus "${GPU_LIST}"
  --seeds "${SEEDS}"
...
echo "[All Done] baseline StageG cross6x9 completed: ${DATASETS}"
