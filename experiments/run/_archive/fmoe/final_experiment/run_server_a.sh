...
run_stage1() {
  echo "[final_experiment][server_a] stage1 datasets=${DATASETS} models=${ALL_MODELS} gpus=${GPU_LIST} max_run_hours=${MAX_RUN_HOURS} oom_retry_limit=${OOM_RETRY_LIMIT}"
...
run_stage2() {
  echo "[final_experiment][server_a] stage2 datasets=${DATASETS} models=${ALL_MODELS} gpus=${GPU_LIST} max_run_hours=${MAX_RUN_HOURS} oom_retry_limit=${OOM_RETRY_LIMIT}"
...
run_stage3() {
  echo "[final_experiment][server_a] stage3 datasets=${DATASETS} models=${ALL_MODELS} gpus=${GPU_LIST} max_run_hours=${MAX_RUN_HOURS} oom_retry_limit=${OOM_RETRY_LIMIT}"
