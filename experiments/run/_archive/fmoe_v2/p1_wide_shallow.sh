...
LAYOUT_CONFIG_PATH="${EXP_DIR}/configs/model/featured_moe_v2_tune.yaml"
...
catalog = (
    ((cfg.get("layout_execution") or {}).get("fmoe_v2_layout_catalog"))
    or cfg.get("fmoe_v2_layout_catalog")
    or []
)
if not isinstance(catalog, list):
    raise SystemExit("invalid fmoe_v2_layout_catalog")
