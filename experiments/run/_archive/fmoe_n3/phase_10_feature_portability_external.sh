...
DATASETS="amazon_beauty,foursquare,movielens1m,retail_rocket"
GPU_LIST="0,1,2,3"
SEEDS="1"
MAX_EVALS="10"
TUNE_EPOCHS="100"
...
usage() {
  cat <<USAGE
Usage: $0 [--datasets amazon_beauty,foursquare,movielens1m,retail_rocket] [--gpus 0,1,2,3]
...
echo "[All Done] phase10 feature portability (external datasets) completed in order: ${DATASETS}"
