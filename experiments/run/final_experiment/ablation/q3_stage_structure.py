...
from common import common_arg_parser, build_train_rows, parse_csv_ints, q3_settings, run_jobs, selected_candidates_from_args, write_manifest  # noqa: E402


def main() -> int:
    parser = common_arg_parser("Q3 stage structure ablations", question="q3")
